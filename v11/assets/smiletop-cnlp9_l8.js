import{x as g,h as b,$ as i,y,M as n,A as e,b as d,c as u,a as m,F as $,j as w,B as A}from"./widev-BK9aTxWX.js";/* empty css              */g(b,async l=>{l?S():window.location.href="/"});i(".logout-btn").click(async()=>{try{await y(b),n("Sesión cerrada correctamente","success"),window.location.href="/"}catch(l){console.error(l)}});async function S(l){const h=`
