import{o as g,f as b,$ as i,n as y,M as n,v as e,b as d,c as u,a as m,B as $,t as w,x as A}from"./widev-DafOInWK.js";/* empty css              */g(b,async l=>{l?S():window.location.href="/"});i(".logout-btn").click(async()=>{try{await y(b),n("Sesión cerrada correctamente","success"),window.location.href="/"}catch(l){console.error(l)}});async function S(l){const h=`
